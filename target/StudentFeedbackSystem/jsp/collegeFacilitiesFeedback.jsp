                                        ...
                                        <% } %>
                                            ...
                                            <div class="form-row">
                                                <div>
                                                    ...
                                                    <select name="program" required>
                                                        ...
                                                        <option value="EEE" <%="EEE" .equals(bean.getProgram())
                                                            ? "selected" : "" %>>EEE</option>
                                                        <option value="CSE" <%="CSE" .equals(bean.getProgram())
                                                            ? "selected" : "" %>>CSE</option>
                                                        <option value="ME" <%="ME" .equals(bean.getProgram())
                                                            ? "selected" : "" %>>Mechanical</option>
                                                        <option value="CE" <%="CE" .equals(bean.getProgram())
                                                            ? "selected" : "" %>>Civil</option>
                                                    </select>
                                                </div>
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <% String[] questions={ "Book Bank facility" , "Reference Books"
                                                        , "Newspapers & Magazines"
                                                        , "Availability of Newspapers & Magazines"
                                                        , "Availability of Office Staff" , "Behavior of Staff"
                                                        , "Interaction with Principal" , "Interaction with HODs"
                                                        , "Extra Curricular Activities" , "Discipline in Campus"
                                                        , "House Keeping" , "Drinking Water Facility"
                                                        , "Proctoring System" , "Infrastructure" }; int[]
                                                        ratings={bean.getQ1(), bean.getQ2(), bean.getQ3(), bean.getQ4(),
                                                        bean.getQ5(), bean.getQ6(), bean.getQ7(), bean.getQ8(),
                                                        bean.getQ9(), bean.getQ10(), bean.getQ11(), bean.getQ12(),
                                                        bean.getQ13(), bean.getQ14()}; for(int i=0; i<questions.length;
                                                        i++){ %>
                                            ...
                                            <div class="buttons">
                                                <input type="submit" name="operation"
                                                    value="<%=CollegeFacilitiesFeedbackCtl.OP_SAVE%>" class="submit-btn"
                                                    style="color: white; border: none; padding: 10px 25px; border-radius: 25px; font-weight: 600; cursor: pointer;">
                                                <input type="submit" name="operation"
                                                    value="<%=CollegeFacilitiesFeedbackCtl.OP_RESET%>" class="reset-btn"
