					...
					<div class="collapse navbar-collapse" id="navbarMain">
							...
							<% if (userLoggedIn) { boolean isAdmin=userBean.getRoleId()==1 || userBean.getRoleId()==3
								...
								<% if (isAdmin) { %>
									...
									<% } %>
										...
										<% if (isStudent) { %>
											<li class="nav-item"><a class="nav-link nav-link-premium"
													href="<%=CFSView.TEACHER_LIST_CTL%>">Faculty</a></li>
											<li class="nav-item"><a class="nav-link nav-link-premium"
						...
						<div class="d-flex align-items-center justify-content-end" style="gap: 1.25rem;">
							...
							<div class="dropdown language-dropdown">
								...
								<ul class="dropdown-menu border-0 shadow-lg p-2 mt-2"
									aria-labelledby="translateDropdown" style="border-radius: 12px; min-width: 160px;">
									<li>
							...
							<% if (!userLoggedIn) { %>
								<div class="d-flex align-items-center" style="gap: 1rem;">
									<a href="<%=CFSView.LOGIN_CTL%>" class="text-dark fw-bold text-decoration-none">Sign
										In</a>
								...
								<% } else { %>
									<div class="user-profile-menu d-none d-md-flex">
										...
										<a href="<%=CFSView.LOGIN_CTL%>?operation=logout" class="btn-logout-premium">
											Logout
										</a>
									</div>
