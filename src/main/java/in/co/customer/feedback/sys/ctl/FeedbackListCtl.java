...
public class FeedbackListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setFeedback(DataUtility.getString(request.getParameter("name")));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || "Next".equalsIgnoreCase(op) || "Previous".equalsIgnoreCase(op)) {
				...
				ServletUtility.redirect(CFSView.FEEDBACK_LIST_CTL, request, response);
				return;
	...
	protected String getView() {
		return CFSView.FEEDBACK_LIST_VIEW;
	}
}
