...
public class UserModel {
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			pstmt.setLong(15, bean.getDeptId());
			pstmt.setString(16, bean.getSemester());
			pstmt.executeUpdate();
	...
	public UserBean findByUserName(String UserName) throws ApplicationException {
		...
		try {
			...
			while (rs.next()) {
				...
				bean.setDeptId(rs.getLong(15));
				bean.setSemester(rs.getString(16));
			}
			rs.close();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			pstmt.setLong(14, bean.getDeptId());
			pstmt.setString(15, bean.getSemester());
