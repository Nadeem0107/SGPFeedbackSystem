...
/**
 * Parents Feedback List functionality Controller.
 * 
 * @author
 * @version 1.0
 * @Copyright (c)
 */
@WebServlet(name = "ParentsFeedbackListCtl", urlPatterns = { "/ctl/parentsFeedbackList" })
public class ParentsFeedbackListCtl extends BaseCtl {

    private static Logger log = Logger.getLogger(ParentsFeedbackListCtl.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        log.debug("ParentsFeedbackListCtl doGet Started");
        List list = null;
        int pageNo = 1;
        ...
        log.debug("ParentsFeedbackListCtl doGet End");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        log.debug("ParentsFeedbackListCtl doPost Started");
        List list = null;
        ...
        try {
            if (OP_SEARCH.equalsIgnoreCase(op) || "Next".equalsIgnoreCase(op) || "Previous".equalsIgnoreCase(op)) {
                ...
                ServletUtility.redirect(CFSView.PARENTS_FEEDBACK_LIST_CTL, request, response);
                return;
            }
        ...
        log.debug("ParentsFeedbackListCtl doPost End");
    }

    @Override
    protected String getView() {
        return CFSView.PARENTS_FEEDBACK_LIST_VIEW;
    }
