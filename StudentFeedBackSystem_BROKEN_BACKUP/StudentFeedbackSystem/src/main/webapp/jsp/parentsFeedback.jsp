<%@ page language="java" pageEncoding="UTF-8" %>
    <%@ page import="in.co.customer.feedback.sys.ctl.CFSView" %>
        <%@ page import="in.co.customer.feedback.sys.ctl.ParentsFeedbackCtl" %>
            <!DOCTYPE html>
            <html>
            ...
            <body>
                <%@ include file="header.jsp" %>
                    ...
                    <div class="container">
                        ...
                        <h2 class="title">PARENTS FEEDBACK</h2>

                        <form action="<%=CFSView.PARENTS_FEEDBACK_CTL%>" method="post">
                            <jsp:useBean id="bean" class="in.co.customer.feedback.sys.bean.ParentsFeedbackBean"
                                        ...
                                        <% } %>
                                            ...
                                            <table>
                                                <thead>
                                                    <tr>
                                                        <th>Sl No</th>
                                                        <th class="description">Feedback Parameter</th>
                                                        <th>1</th>
                                                        <th>2</th>
                                                        <th>3</th>
                                                        <th>4</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <% String[] questions={ "Quality of Teaching"
                                                        , "Discipline in College" , "Infrastructure"
                                                        , "Communication with Parents" , "Overall Satisfaction" }; int[]
                                                        ratings={bean.getQ1(), bean.getQ2(), bean.getQ3(), bean.getQ4(),
                                                        bean.getQ5()}; for(int i=0;i<questions.length;i++){ %>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <% for(int j=1;j<=5;j++){ String checked=(ratings.length> i
                                                                &&
                                                                ratings[i] == j) ? "checked" : "";
                                                                %>
                                                                <td><input type="radio" name="q<%=i+1%>" value="<%=j%>"
                                                                        required <%=checked%>></td>
                                                                <% } %>
                                            ...
                                            <div class="buttons">
                                                <input type="submit" name="operation"
                                                    value="<%=ParentsFeedbackCtl.OP_SAVE%>" class="submit-btn"
                                                    style="color: white; border: none; padding: 10px 25px; border-radius: 25px; font-weight: 600; cursor: pointer;">
                                                <input type="submit" name="operation"
                                                    value="<%=ParentsFeedbackCtl.OP_RESET%>" class="reset-btn"
