                        ...
                        <div class="container">
                            ...
                            <form action="<%=CFSView.COURSE_END_FEEDBACK_CTL%>" method="post">
                                ...
                                <% if(in.co.customer.feedback.sys.util.ServletUtility.getSuccessMessage(request) !=null
                                    &&
                                    in.co.customer.feedback.sys.util.ServletUtility.getSuccessMessage(request).length()>
                                    0)
                                    { %>
                                            ...
                                            <% } %>
                                                ...
                                                <div class="form-row">
                                                        ...
                                                        <% List tList=(List) request.getAttribute("teacherList"); %>
                                                            <select name="coordinator" required>
                                                                ...
                                                                <% if (tList !=null) { for (Object o : tList) {
                                                                    ...
                                                                    tBean=(in.co.customer.feedback.sys.bean.TeacherBean)
                                                                    o; %>
                                                                    <option value="<%=tBean.getName()%>"
                                                                        <%=tBean.getName().equals(bean.getCoordinator())
                                                                        ? "selected" : "" %>><%=tBean.getName()%>
                                                                    </option>
                                                                    <% } } %>
                                                            </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="sem" readonly
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <% String[] outcomes={ "Understand career planning concepts"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <% for(int j=1; j<=5; j++){ String
                                                                    checked=(ratings.length>
                                                                    i &&
                                                                    ratings[i] == j) ? "checked" : "";
                                                                    %>
                                                                    <td>
                                                                        <input type="radio" name="co<%=i+1%>"
                                                                            value="<%=j%>" required <%=checked%>>
                                                                    </td>
                                                                    <% } %>
                                                            </tr>
