<%@page import="in.co.customer.feedback.sys.ctl.ProductCtl" %>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-card">
                                                <div class="form-header">
                                                    ...
                                                    <% String title=(DataUtility.getLong(request.getParameter("id"))> 0)
                                                        ? "Edit Faculty Profile" : "Register New Faculty";
                                                        %>
                                                        <h2>
                                                            <%=title%>
                                                        </h2>
                                                        <p class="mb-0 opacity-75">Fill in the details to update the
                                                                    ...
                                                                    <form method="post"
                                                                        ...
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <div class="text-muted mt-2"
                                                                                ...
                                                                                professional headshot (JPG, PNG)</div>
                                                                        </div>

                                                                        <div class="mb-4">
                                                                            <label class="form-label">Faculty Expertise
                                                                                / Description</label>
                                                                            <textarea rows="4"
