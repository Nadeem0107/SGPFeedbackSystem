<%@page import="in.co.customer.feedback.sys.ctl.CFSView" %>
    <%@page import="in.co.customer.feedback.sys.bean.CollegeFacilitiesFeedbackBean" %>
            ...
            <%@page import="java.util.Iterator" %>
                <%@page import="java.util.List" %>
                    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                        ...
                        <head>
                            <meta charset="UTF-8">
                            <title>College Facilities Feedback List</title>
                            <!-- Font Awesome -->
                        ...
                        <body>
                            <%@ include file="header.jsp" %>
                                        ...
                                        <ol class="breadcrumb"
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"
                                                ...
                                                <i class="fas fa-long-arrow-alt-right"
                                                    style="margin-right: 8px; color: #6a1b9a;"></i> College Facilities
                                                Feedback List
                                            </li>
                                        </ol>
                                    </nav>
                                ...
                                <hr>
                                <form method="post" action="<%=CFSView.COLLEGE_FACILITIES_FEEDBACK_LIST_CTL%>">
                                    <div class="card">
                                                ...
                                                <table class="table table-bordered border-primary">
                                                    ...
                                                    <tbody>
                                                        <% int pageNo=ServletUtility.getPageNo(request); int
                                                            ...
                                                            CollegeFacilitiesFeedbackBean bean=null; List
                                                            list=ServletUtility.getList(request); if(list !=null){
                                                            Iterator<CollegeFacilitiesFeedbackBean> iterator =
                                                            list.iterator();
