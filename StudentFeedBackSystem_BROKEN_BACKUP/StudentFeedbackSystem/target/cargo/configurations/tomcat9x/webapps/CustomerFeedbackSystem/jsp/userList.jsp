			...
			<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
				...
				<body>
					<%@ include file="header.jsp" %>
						...
						<hr>
						<form method="post" action="<%=CFSView.USER_LIST_CTL%>">
							<div class="card">
								<h5 class="card-header" style="background-color: #00061df7; color: white;">Student List
								</h5>
								<div class="card-body">
									<div class="row g-3">
										...
										<div class="col">
											<input type="text" placeholder="Search By Email here..." name="email"
												class="form-control" value="<%=ServletUtility.getParameter(" email",
												request)%>">
										</div>
									...
									<table class="table table-bordered border-primary">
										...
										<tbody>
											<% int pageNo=ServletUtility.getPageNo(request); int
												...
												pageSize) + 1; int size=ServletUtility.getSize(request); UserBean
												bean=null; List list=ServletUtility.getList(request); Iterator<UserBean>
												...
												<tr>
													...
													<td scope="row">
														<a href="<%=CFSView.USER_CTL%>?id=<%=bean.getId()%>"
									...
									<div class="clearfix">
										<%-- <input type="submit" name="operation"
											class="btn btn-sm btn-danger float-start" <%=(list.size()==0) ? "disabled"
											: "" %>
											value="Delete"> --%>
